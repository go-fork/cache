...
## Download
- Source code: [go.fork.vn/cache@$target_version]
- Documentation: [pkg.go.dev/go.fork.vn/cache@$target_version]
...
\`\`\`bash
go get go.fork.vn/cache@$target_version
go mod tidy
\`\`\`
...
## Getting Help
- Check the [documentation](https://pkg.go.dev/go.fork.vn/cache@$target_version)
